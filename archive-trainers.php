                ...
                <ul class="trainers-list">
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic1.png'); ?>" alt=""
                    ...
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic2.png'); ?>" alt=""
                                 class="trainer__thumb">
                            <div class="trainer__wrap">
                                <h2 class="trainer__name"> Юзвак Дмитрий </h2>
                                <p class="trainer__text"> Хореограф. Преподаватель Dance Mix, Twerk, Strip dance и др
                                    направлений. Официальный представитель UBPF. Чемпионка Европы по фитнес Бикини.
                                    Тренер
                    ...
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic3.png'); ?>" alt=""
                                 class="trainer__thumb">
                            <div class="trainer__wrap">
