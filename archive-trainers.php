                ...
                <ul class="trainers-list">
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic1.png'); ?>" alt="" class="trainer__thumb">
                    ...
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic2.png'); ?>" alt="" class="trainer__thumb">
                            <div class="trainer__wrap">
                    ...
                    <li class="trainers-list__item">
                        <article class="trainer">
                            <img src="<?php echo _si_assets_path('img/trainers__trainer_pic3.png'); ?>" alt="" class="trainer__thumb">
                            <div class="trainer__wrap">
