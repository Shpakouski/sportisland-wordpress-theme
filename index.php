            ...
            <ul class="posts-list">
                <li class="last-post">
                    <a href="single.html" class="last-post__link"
                        aria-label="Читать текст статьи: Растяжка от болей в мышцах">
                        <figure class="last-post__thumb">
                            <img src="<?php echo _si_assets_path('img/blog__article_thmb1.jpg'); ?>" alt="" class="last-post__img">
                        </figure>
                ...
                <li class="last-post">
                    <a href="single.html" class="last-post__link"
                        ...
                        <figure class="last-post__thumb">
                            <img src="<?php echo _si_assets_path('img/blog__article_thmb2.jpg'); ?>" alt="" class="last-post__img">
                        </figure>
                        <div class="last-post__wrap">
    ...
    <section class="categories">
        <div class="wrapper">
            ...
            <ul class="categories-list">
                ...
                <li class="category">
                    <a href="category.html" class="category__link">
                        <img src="<?php echo _si_assets_path('img/blog__category_thmb2.jpg'); ?>" alt="" class="category__thumb">
                        <span class="category__name">Кардио</span>
                    </a>
                </li>
                <li class="category">
                    <a href="category.html" class="category__link">
                        <img src="<?php echo _si_assets_path('img/blog__category_thmb3.jpg'); ?>" alt="" class="category__thumb">
...
<main class="main-content">
    ...
    <div class="wrapper">
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
                <a href="blog.html" class="breadcrumbs__link">Страница</a>
            </li>
        </ul>
    </div>
    <section class="last-posts">
